...
def mainlist(item):
    ...
    itemlist = []
    itemlist.append( Item(channel=item.channel, action="submenu", title="PelÃ­culas", url="http://www.newpct1.com/", extra="peliculas") )
...
def listado(item):
    ...
    if "pagination" in data:
        ...
        if "Next" in paginacion:
            ...
            itemlist.append( Item(channel=item.channel, action="listado" , title=">> PÃ¡gina siguiente" , url=url_next_page, extra=item.extra))            
