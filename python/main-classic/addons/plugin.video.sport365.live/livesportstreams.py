...
BASEURL='http://www.livesportstreams.tv/es/home'
...
def getChannels(addheader=False):
    ...
    url = 'http://www.livesportstreams.tv/es/events/-/1/-/-/' + str(minutes)
    ...
    for i in range(len(ids[:-1])):
        ...
        if links and title2:
            ...
            url = 'http://www.livesportstreams.tv/es/links/%s/1@%s'%(event.split('_')[-1],ret)
            etime,title1= t[:2]
            lang = t[-1]
