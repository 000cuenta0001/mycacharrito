...
if mode is None:
    addDir('livesportstreams.tv', ex_link='', params={'_service':'livesportstreams','_act':'ListChannels'}, mode='site2', iconImage=ICON, fanart=FANART)
    #li = xbmcgui.ListItem(label = '[COLOR blue]aktywuj PVR Live TV[/COLOR]', iconImage=RESOURCES+'PVR.png')
    #xbmcplugin.addDirectoryItem(handle=addon_handle, url=build_url({'mode': 'Opcje'}) ,listitem=li)
	
if mode is None:
    addDir('Deportes247',ex_link='',params={'_service':'Deportes247','_act':'ListChannels'}, mode='site2',iconImage=ICON, fanart=FANART)
	#li = xbmcgui.ListItem(label = '[COLOR blue]aktywuj PVR Live TV[/COLOR]', iconImage=RESOURCES+'PVR.png')
    #xbmcplugin.addDirectoryItem(handle=addon_handle, url=build_url({'mode': 'Opcje'}) ,listitem=li)
	
if mode is None:
    addDir('s365',ex_link='',params={'_service':'s365','_act':'ListChannels'}, mode='site2',iconImage=ICON, fanart=FANART)
	#li = xbmcgui.ListItem(label = '[COLOR blue]aktywuj PVR Live TV[/COLOR]', iconImage=RESOURCES+'PVR.png')
    #xbmcplugin.addDirectoryItem(handle=addon_handle, url=build_url({'mode': 'Opcje'}) ,listitem=li)
