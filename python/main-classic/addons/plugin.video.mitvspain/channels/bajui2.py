...
def mainlist(item):
    logger.info()
    itemlist = []
    itemlist.append( Item(channel=item.channel, title="Películas"                , action="menupeliculas", url="http://www.bajui2.com/descargas/categoria/2/peliculas",fanart="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/fanart/bajui.jpg"))
...
def menuseries(item):
    logger.info()
    itemlist = []
    itemlist.append( Item(channel=item.channel, title="Series - Novedades"           , action="peliculas"        , url="http://www.bajui2.com/descargas/categoria/3/series",fanart="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/fanart/bajui.jpg", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Series - A-Z"                 , action="peliculas"        , url="http://www.bajui2.com/descargas/categoria/3/series/orden:nombre",fanart="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/fanart/bajui.jpg", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Series - HD"                  , action="peliculas"        , url="http://www.bajui2.com/descargas/subcategoria/11/hd/orden:nombre",fanart="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/fanart/bajui.jpg", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Buscar"                       , action="search"            , url="",fanart="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/fanart/bajui.jpg") )
    return itemlist
...
def menudocumentales(item):
    logger.info()
    itemlist = []
    itemlist.append( Item(channel=item.channel, title="Documentales - Novedades"         , action="peliculas"     , url="http://www.bajui2.com/descargas/categoria/7/docus-y-tv",fanart="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/fanart/bajui.jpg", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Documentales - A-Z"               , action="peliculas"     , url="http://www.bajui2.com/descargas/categoria/7/docus-y-tv/orden:nombre",fanart="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/fanart/bajui.jpg", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Buscar"                           , action="search"        , url="",fanart="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/fanart/bajui.jpg") )
    return itemlist
