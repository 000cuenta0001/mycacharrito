...
def mainlist(item):
    logger.info()
    itemlist = []
    itemlist.append( Item(channel=item.channel, title="Películas"                , action="menupeliculas", url="http://www.bajui.com/descargas/categoria/2/peliculas",fanart="https://raw.githubusercontent.com/MiTvSpain/mitvspain/master/fanart/bajui.jpg"))
